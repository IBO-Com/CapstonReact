...
const App = () => {
  ...
  useEffect(() => {
    axios
      .post(
        "http://43.200.115.198:8080/vacationcount.jsp",
        qs.stringify({
      ...
      .then((res) => {
        ...
        let _max =
          parseFloat(data_.remain_annual) + parseFloat(data_.use_annual);
      ...
      if (data.ann_state == "0") {
        ...
        component.push(
          ...
          >
            ...
            >
              {" "}
              {annualData[data.vacation]} 신청이 승인됐어요!
            </p>
          </div>
        );
      }
      ...
      <div className="hrMain_container">
          ...
          <div className="hrMain_user_container">
            ...
            <div className="hrMain_userInfo">
              ...
              <div className="hrMain_userDetail">
                <li className="hrMain_userName">
                  {userData["name"] ? userData["name"] : "로딩중"}
                </li>
                <li>{userData["sabun"] ? userData["sabun"] : "로딩중"}</li>
                <li className="hrMain_dept">
                  {userData["centerKR"] ? userData["centerKR"] : "로딩중"}
                </li>
                <li className="hrMain_subDept">
                  {userData["deptKR"] ? userData["deptKR"] : "로딩중"}
                </li>
                <li className="hrMain_Team">
                  {userData["teamKR"] ? userData["teamKR"] : "로딩중"}
                </li>
              </div>
            </div>
          </div>
          <div className="hrMain_work_container">
            <div>
              ...
              <div className="hrMain_workInfo">
                <div className="hr_timeNwork">{todayTime()}</div>
                {data ? (
                  <ApexCharts
                      ...
                      return (
                        <>
                          <tr>
                            ...
                            <td style={{ minWidth: "80px" }}>
                              {item.ann_state === "0" ? "대기중" : "처리완료"}
                            </td>
                            <td style={{ minWidth: "100px" }}>
                              {item.rep_name} {item.rep_rankKR}
                            </td>
                          </tr>
                        </>
                      );
        ...
        <div className="hrMain_notice_container">
          ...
          <div className="hrMain_notice">
            <p>{pay()}</p>
            <p>{annNotice().map((item, index) => item)}</p>
          </div>
        </div>
      </div>
    </div>
